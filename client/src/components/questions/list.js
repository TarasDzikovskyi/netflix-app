export const list = [
    {
        question: 'What is Netflix?',
         ...
         answer2: "You can watch as much as you want, whenever you want without a single"+
         "commercial – all for one low monthly price. There's always something new to"+
...

    {
        question: 'How much does Netflix cost?',
         ...
         "streaming device, all for one fixed monthly fee. Plans range from EUR4.99 "+
         "to EUR9.99 a month. No extra costs, no contracts."
    },

    {
        question: 'Where can I watch?',
         answer: "Watch anywhere, anytime. Sign in with your Netflix account to watch "+
         ...
         answer2: "You can also download your favorite shows with the iOS, Android, or Windows 10 app. "+
...

    {
        question: 'What can I watch on Netflix?',
         answer: "Netflix has an extensive library of feature films, documentaries, TV shows, "+
